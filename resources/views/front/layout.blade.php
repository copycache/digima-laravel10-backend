...
<body>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="javascript:">Services</a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="javascript:">General Consultancy</a></li>
                                                <li><a class="dropdown-item" href="javascript:">General Supply Services</a></li>
                                                <li><a class="dropdown-item" href="javascript:">Holding Services</a></li>
                                                <li><a class="dropdown-item" href="javascript:">I.T. Services</a></li>
                                                <li><a class="dropdown-item" href="javascript:">Importing & Exporting Services</a></li>
                                                <li><a class="dropdown-item" href="javascript:">Man Power Services</a></li>
                                                <li><a class="dropdown-item" href="javascript:">Marketing</a></li>
                            ...
                            <div class="header-content__bottom-feature">
                                ...
                                <nav class="header-content__top-nav__nav-links">
                                    <ul>
                                        ...
                                        <li class="ml-3">
                                            <a href="javascript:" class="my-cart-icon popup" size="lg" link="/my-cart"><i class="fas fa-shopping-cart"></i> My Cart</a>
    ...
    <div id="fb-root"></div>
      ...
      <div class="fb-customerchat"
        ...
        page_id="104237260999424"
  theme_color="#fa3c4c"
  logged_in_greeting="Hi! How can we help you? Jeric Single!!!"
  logged_out_greeting="Hi! How can we help you? Jeric Single!!!">
    </div>
</body>
</html>
