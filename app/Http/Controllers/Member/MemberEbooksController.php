...
class MemberEbooksController extends Controller
{
    ...
    public function get_selected_tools()
    {
        ...
        $response->image_required = Tbl_marketing_tools_category::where('id', $response->category)->where('archived', 0)->first()->image_required;
        $response->video_required = Tbl_marketing_tools_category::where('id', $response->category)->where('archived', 0)->first()->video_required;
        $response->file_required = Tbl_marketing_tools_category::where('id', $response->category)->where('archived', 0)->first()->file_required;
